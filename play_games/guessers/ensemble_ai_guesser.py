    ...
    class StrategyOne(object):
        ...
        def update_values(self):
            ...
            for key in self.outer.bot_weights:
                ...
                self.outer.bot_weights[key] = curr_score + (self.ubc_constant * (np.sqrt(np.log(self.outer.total_rounds) / total_rounds_used)))
        ...
        def reset_stats(self):
            #because our method of bot selection is turn dependent, we don't need to reset anything at the end of a game. 
            pass
